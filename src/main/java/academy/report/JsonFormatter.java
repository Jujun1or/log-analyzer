...
public class JsonFormatter implements ReportFormatter {
    ...
    public static record JsonReport(
        ...
        List<CodeItem> responseCodes,

        @JsonProperty("requestsPerDate")
        List<DateItem> requestsPerDate,
        ...
        public static JsonReport from(ReportTotalStats stats, List<ResolvedSource> sources) {
            ...
            return new JsonReport(
                ...
                new ResponseSize(
                    (long) stats.averageResponseSize(),
                    stats.maxResponseSize(),
                    stats.percentile95()
                ),
    ...
    public static record DateItem(String date, String weekday, long totalRequestsCount, double totalRequestsPercentage) {}
}
